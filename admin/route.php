		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="01" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Train Type </th>
								<th> Route </th>
								<th> Seat Number </th>
								<th> Price </th>
								<th> Time </th>
				...
				<div id="footer" class="radius-bottom">
					2011-12 �
					<a class="afooter-link" href="">TurboAdmin</a>
					by
					<a class="afooter-link" href="">Guneet</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
