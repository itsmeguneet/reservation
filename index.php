...
<title>Welcome to WorldWide Railways Reservation</title>
...
<div id="wrapper">
	<div id="header">
        ...
        <ul id="mainnav">
            ...
            <li><a href="history.php">INFO</a></li>
    ...
    <div id="content">
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Ticket Reservation</h2>
    ...
    <div id="featured">
        <div id="items">
            ...
            <h3><a href="main-course.php">Special Offers</a></h3>
            <p><a href="#"><strong>Special Train</strong><br />
			Come in and experience<br /> Our
			new Rail Type<br /> special today!</a></p>
            </div>
            <div class="item"> <a href=''><img src="xres/images/02_featured.jpg" alt="" /></a>
            <h3><a href="">New Route</a></h3>
            <p><a href=""><strong>From Kathmandu to Pokhara and Vice versa</strong><br />
			Enjoy our service, enjoy yourselves. </a></p>
			</div>
	...
	<div id="footer">
	<h4>+977980-898-7122 &bull;  Sanepa, Lalitpur, Bagmati, Nepal  </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<p>&copy; Copyright 2016 WorldWide Railways | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
